...
Seedance 2.0 / HappyHorse / Wan 2.7 视频生成、Seedream / Dola Seedream 图片生成与 Doubao Seed Audio 音频生成 API 的 ComfyUI 节点插件，默认接入 [api.seedance.nz](https://api.seedance.nz)。

本插件提供文生视频、图生视频、多模态视频、HappyHorse 1.1 视频、Wan 2.7 Spicy 图生视频、Seedream / Dola Seedream 文生图/图像编辑，以及 Doubao Seed Audio 1.0 音频生成节点。图片、视频、音频参考素材会自动上传到 API，不需要额外准备图床或外链。
...
- 新增 3 个 HappyHorse 1.1 视频模型、1 个 Wan 2.7 Spicy 视频模型、2 个 Dola Seedream 图片模型和 1 个 Doubao Seed Audio 模型
- 支持国内线路和 `global` 海外线路
